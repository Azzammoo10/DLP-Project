...
const STEPS = [
  {
    ...
    detail: "Agent Windows (filescanner, usbmonitor...) détecte un événement sensible.",
    layer: "Endpoint",
    color: "#94a3b8",
    arrow: true,
  },
  {
    step: "02",
    title: "Envoi Alerte — alertsender.py",
    detail: "HTTP POST vers l'API Flask (192.168.100.10:5000) ou mise en file d'attente locale si indisponible.",
    layer: "Transport",
    color: "#3b82f6",
    arrow: true,
  },
  {
    step: "03",
    title: "Réception & Log — manager.py",
    detail: "L'API Flask reçoit, normalise, et écrit l'alerte en JSONL thread-safe (/var/log/dlp/dlp.json).",
    layer: "DLP Server",
    color: "#ef4444",
    arrow: true,
  },
  {
    step: "04",
    title: "Ingestion Log — Wazuh Agent",
    detail: "L'agent Wazuh surveille /var/log/dlp/dlp.json (file monitoring) et décode le JSON custom.",
    layer: "SIEM",
    color: "#a855f7",
    arrow: true,
  },
  {
    step: "05",
    title: "Corrélation & Alerting — Wazuh Manager",
    detail: "Les règles Wazuh corrèlent les événements et génèrent une alerte dans le dashboard SOC.",
    layer: "SOC",
    color: "#f59e0b",
    arrow: true,
  },
  {
    ...
    detail: "L'analyste SOC investigue, avec escalade D1 automatique si le seuil d'occurrences dépasse 5.",
    layer: "Response",
    color: "#10b981",
    arrow: false,
  },
